...
[![GoDoc Documentation](http://godoc.org/github.com/hoffmannandrey/hystrix-go/hystrix?status.png)](https://godoc.org/github.com/hoffmannandrey/hystrix-go/hystrix)
...
For API documentation, refer to [GoDoc](https://godoc.org/github.com/hoffmannandrey/hystrix-go/hystrix)

How to use
----------

```go
import "github.com/hoffmannandrey/hystrix-go/hystrix"
```
...
- ```cd /go/src/github.com/hoffmannandrey/hystrix-go```
- ```go test ./...```
